package com.udemy.routeservices.Utils.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.udemy.routeservices";
    private static final String CHANNEL_NAME = "RouteServices";
