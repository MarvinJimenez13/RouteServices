...
import com.udemy.routeservices.Interfaces.client.map_client.MapClientView;
import com.udemy.routeservices.Presenters.client.MapClientPresenterImpl;
...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback, MapClientView {
    ...
    public void addActiveDriverMarkers(GeoLocation location, DataSnapshot dataSnapshot) {
        ...
        Marker marker = map.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.uber_car)));
